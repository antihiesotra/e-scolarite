<template>
  ...
  >
    <q-toolbar slot="header" style="padding-top: 0;padding-bottom: 0;">
      ...
      <q-toolbar-title>
        eScola
        <span slot="subtitle">Responsable de parcours</span>
      </q-toolbar-title>
      ...
      <q-route-tab slot="title" icon="people" to="/plan-de-formation" replace label="Plan de formation" />
      <!--
      <q-route-tab slot="title" icon="view_array" to="/atome-pedagogique" replace label="Atome pédagogique" />
      
      <q-route-tab slot="title" icon="content_paste" to="/attribuer-ue" replace label="Attribuer UE" />
      <q-route-tab slot="title" icon="content_paste" to="/attribuer-ec" replace label="Attribuer EC" />
       -->
      <q-route-tab slot="title" icon="school" to="/parametre" replace label="Paramètre" />
    </q-tabs>

    <q-scroll-area slot="left" class="_navbar"  style="width: 100%; height: 100%">
      <q-list-header>Menu générale</q-list-header>
      <q-side-link item to="/parcours/plan-de-formation" style="height: 60px">
        <q-item-side icon="assignment" />
        <q-item-main label="Plan de formation" sublabel="" />
      </q-side-link>
      <!-- 
      <q-side-link v-if="false" item to="/parcours/atome-pedagogique" style="height: 60px">
        <q-item-side icon="fa-snowflake-o" />
        <q-item-main label="Atome pédagogique" sublabel="" />
      </q-side-link>
      <q-side-link item to="/parcours/attribuer-ue" style="height: 60px">
        <q-item-side icon="fa-yelp" />
        <q-item-main label="Attribuer UE" sublabel="" />
      </q-side-link>
      <q-side-link item to="/parcours/attribuer-ec" style="height: 60px">
        <q-item-side icon="fa-joomla" />
        <q-item-main label="Attribuer EC" sublabel="" />
      </q-side-link>
       -->
      <q-side-link item to="/parcours/afficheparametres" style="height: 60px">
        <q-item-side icon="settings" />
        <q-item-main label="Paramètre" sublabel="" />
      </q-side-link>
