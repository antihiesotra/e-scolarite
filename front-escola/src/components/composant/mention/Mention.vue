<template>
  <div class="layout-padding">
    <div class="modif_composant">
      <q-btn color="primary" class="animate-pop" @click="openComposantModal = true">
    ...
    <!-- Modifier curret composant -->
    <q-modal @close="closeComposantModal" v-model="openComposantModal" class="_addModal" :content-css="{borderRadius: '4px', paddingBottom: '20px',minWidth: '40vw', minHeight: '80vh'}">
      <ModifierComposant :mycomposant="composant" :responsableOptions="responsableOptions" @close="closeComposantModal"/>
    </q-modal>
    ...
    <q-fixed-position corner="bottom-left" :offset="[18, 18]">
      <q-fab color="primary" push icon="settings" direction="right">
        <q-btn round color="primary" @click="afficherModalAjout" class="animate-pop">
          <q-tooltip anchor="center right" self="center left" :offset="[10, 10]">Ajouter Mention</q-tooltip>
...
<script>
  ...
  import ModifierComposant from './ModifierComposant.vue'
