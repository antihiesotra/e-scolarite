<template>
  <div class="layout-padding">
    ...
    <q-modal @close="closeAddModal" v-model="openAddModal" class="_addModal" :content-css="{borderRadius: '4px', paddingBottom: '20px',minWidth: '40vw', minHeight: '80vh'}">
      <Ajout :adminData="adminData" @reload="getComposantsByCodeUniv" @close="closeAddModal" @success="successAddComposant" @failure="failureAddComposant" :etablissement="etablissementActuel" />
    </q-modal>
    ...
    <q-modal @close="closeUpdateModal" v-model="openUpdateModal" class="_addModal" :content-css="{borderRadius: '4px', paddingBottom: '20px',minWidth: '40vw', minHeight: '80vh'}">
      <Modifier :adminData="adminData" @reload="getComposantsByCodeUniv" :selectedComposant="selectedComposant" @close="closeUpdateModal" @success="successUpdateComposant" @failure="failureUpdateComposant" />
    </q-modal>
